...
jQuery(document).ready(function($){
	...
	$('#related-projects-list').pajinate({
		...
		items_per_page : 2,
		nav_label_prev : '<img src="/davidcobbmurals/wp-content/themes/paragon/framework/images/previous-button.png" />',
		nav_label_next : '<img src="/davidcobbmurals/wp-content/themes/paragon/framework/images/next-button.png" />',
